								...
								<div className="col-lg-6 px-lg-0">
									{reviewModal.images_data.length === 1 ? (
										...
										<>
											...
											<a className="carousel-control-prev text-primary carousel-control--background d-inline" href="#carouselYotpoImage" role="button" data-slide="prev">
											...
											<a className="carousel-control-next text-primary carousel-control--background d-inline" href="#carouselYotpoImage" role="button" data-slide="next">
